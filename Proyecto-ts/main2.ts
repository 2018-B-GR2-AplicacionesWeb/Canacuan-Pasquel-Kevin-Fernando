...
function main() {
    ...
    respuestaBDD$
        .pipe(
            preguntarOpcionesCRUD(),
            pedirDatosComponente(),
            ejecutarAccion(),
            guardarBaseDeDatos()
        )
        .subscribe(
...
interface OpcionesProducto {
    opcionesProducto: 'Ingresar Nuevo Componente' | 'Buscar Componente' | 'Borrar Componente' | 'Actualizar Componente' | 'Salir';
}
